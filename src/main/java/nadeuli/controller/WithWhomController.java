 ...
 * 고민정    2025.03.19   삭제 API 수정 : emid로 한 번에 모두 삭제
 * ========================================================
 */
...
//    }
    ...
    public ResponseEntity<Void> deleteWithWhom(@PathVariable("iid") Integer iid, @PathVariable("emid") Integer emid) {
        Long expenseItemId = Long.valueOf(emid);
        withWhomService.cancelWithWhom(expenseItemId);
        return ResponseEntity.ok().build();
    }
