    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http,
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/auth/user/me").authenticated() // ✅ 사용자 정보는 인증 필요
                ...
                .sessionManagement(session -> session.sessionCreationPolicy(SessionCreationPolicy.STATELESS)) // ✅ JWT 기반 인증이므로 STATELESS 설정
                ...
                .logout(logout -> logout
                        ...
                        .deleteCookies("JSESSIONID", "accessToken") // ✅ JWT 인증이므로 accessToken 쿠키도 삭제
                        .permitAll()
                )
